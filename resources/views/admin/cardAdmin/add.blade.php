    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-warning">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('card.addPostAdmin') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
                                <!-- text input -->
                                <div class="form-group">
                                    ...
                                    <input type="text" name="card_name" class="form-control" placeholder="Nhập chi nhánh mở thẻ...">
                                    @error('card_name')
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="card_branch" class="form-control" placeholder="Nhập chi nhánh mở thẻ...">
                                    @error('card_branch')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="card_number" class="form-control" placeholder="Nhập số tài khoản mở thẻ...">
                                    @error('card_number')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="bank" class="form-control select2bs4" style="width: 100%;">
                                        @foreach ($banks as $key => $item)
                                            <option value="{{ $key }}" data-thumbnail="{{ $item['image'] }}">{{ $item['name'] }}</option>
                                        @endforeach
                                    </select>
                                    @error('bank')
