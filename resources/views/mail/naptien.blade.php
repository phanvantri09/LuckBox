        ...
        <table style="background-color: #ffffff; border-collapse: collapse; margin: auto; max-width: 600px; width: 100%;">
            <tr>
                <td style="padding: 20px;">
                    <h2 style="color: #333333;">Thông báo Nạp Tiền thành công</h2>  
                    <p style="color: #333333;">Xin chào:   <b>{{$infoUser->name}}</b> ,</p>
                    <p style="color: #333333;">Chúng tôi xin thông báo rằng yêu cầu Nạp Tiền của bạn đã được xử lý thành công.</p>
