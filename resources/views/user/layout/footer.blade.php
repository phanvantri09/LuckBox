<div id="footter" class="container bg-white py-3 footer-content">
    ...
    <div class="row">
        ...
        <div
            class="col-lg-5 text-lg-left text-sm-center text-center col-sm-12 col-12 d-flex flex-column align-items-lg-start align-items-sm-center align-items-center py-1">
            <h5 class="font-weight-bold">VỀ CHÚNG TÔI</h5>
            <p class="mb-0">Công ty cổ phần công nghệ điện tử LUCKBOX</p>
            <p class="mb-0">Địa chỉ: Tòa nhà Daeha Business Center, 360 Kim Mã, Ba Đình, Hà Nội</p>
            <p class="mb-0">Hotline: 1900159639 - 0795 710 839</p>
