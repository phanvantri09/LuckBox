...
@section('content')
    ...
    <div class="content-container py-4">
        <div class="container my-lg-2 my-0">
            <!-- desktop -->
            <div class="row align-items-center bg-orange-white py-2 rounded mb-2 px-2 d-lg-flex d-none">
            ...
            <!-- end desltop -->
            <!-- mobile -->
            <div class="row bg-orange-white py-2 rounded mb-2 px-2 d-lg-none">
