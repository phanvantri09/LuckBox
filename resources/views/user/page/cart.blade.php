                ...
                <div class="d-lg-block d-none">
                    @foreach ($dataCart as $cart)
                        <div class="row align-items-center bg-orange-white py-2 rounded mb-2 px-2">
                            ...
                            <a href="{{ route('stopcart', ['id_cart'=>$cart->id]) }}" class="w-100 col-lg-1 px-lg-0 text-decoration-none">
                        ...
                        <div class="row bg-orange-white py-2 rounded mb-2 px-2">
                            ...
                            <div class="col-md-9 col-sm-9 col-8">
                                ...
                                <div class="d-flex justify-content-between">
                                    <a href="{{ route('stopcart', ['id_cart'=>$cart->id]) }}" class="px-lg-0 text-decoration-none">
